...
package org.linuxforhealth.fhir.ig.mcreations.tool;
...
public class IndexGenerator {
    public static void main(String[] args) throws Exception {
        ...
        File dir = new File("src/main/resources/com/mcreations/fhir/experiment/01/package/");
        ...
        try (OutputStream out = new FileOutputStream("src/main/resources/com/mcreations/fhir/experiment/01/package/.index.json")) {
            index.store(out);
        }
    }
}
